...
<body class="container">
	<div class="jumbotron text-center" style="background: darkorange;
    color: darkorchid;">
        <h2 style="font-size: 33px; color: #fff;">Project - Mini Car Inventory System<h2>
    </div>
        ...
        <div id="manufacturer">
            <form action="#">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="manufacturer_name" placeholder="Enter Manufacturer Name" name="name" required>
                </div>
                <div class="form-group text-center">
                    <button type="button" class="btn btn-default" style="background-color: aqua;" onclick="addManufacturere()">Add</button>
                </div>
            </form>
        </div>
        <div id="model">
